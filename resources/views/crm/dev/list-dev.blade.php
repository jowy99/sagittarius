    ...
    <div class="p-2 md:flex md:items-center md:justify-center md:mt-8">
        <div class="w-full h-full rounded-lg py-8 bg-green-700 dark:bg-green-800 dark:border-green-700 md:w-9/12 md:h-9/12 md:rounded-lg md:p-12">
            ...
            <table class="min-w-full divide-y divide-carbon-300 border border-carbon-600 p-4 md:p-0">
                ...
                <tr>
                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-light-400 font-semibold sm:pl-6 lg:pl-8">{{ $dev->title }}</td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-light-200">{{ $dev->description }}</td>
                    <td class="hidden md:block whitespace-nowrap px-3 py-4 text-sm text-light-200">{{ $dev->github }}</td>
